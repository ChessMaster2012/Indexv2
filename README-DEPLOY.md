...
Rewards update: Study Pack and Focus Pack cost 20 coins; all other packs cost 25 coins. Every pack uses the same rarity odds: 94.5% Common, 4% Rare, 1% Epic, 0.5% Legendary.

The pack tier changes the item pool, not rarity odds.


## Pack rarity odds
All packs use the same rarity odds: Common 66%, Rare 24%, Epic 9%, Legendary 1%. The previously requested 65% + 24% + 9% + 1% totals 99%, so Common is set to 66% so the four rarities total exactly 100%.
