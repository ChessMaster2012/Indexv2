...
app.get('/api/ai/transformers', async (req, res) => {
  try {
    ...
    // Keep any secondary imports on the same origin as well.
    source = source.replaceAll('https://cdn.jsdelivr.net/', '/api/ai/cdn/');
    source = source.replaceAll('https://huggingface.co/', '/api/ai/hf/');
