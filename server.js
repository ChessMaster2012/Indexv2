...
// Keep the production callback fixed so a stale Render environment variable cannot
// send Google a different redirect URI. This exact URI must also be registered
// in the Google OAuth client's Authorized redirect URIs.
const GOOGLE_REDIRECT_URI = 'https://indexv2-x2hw.onrender.com/api/auth/google/callback';
